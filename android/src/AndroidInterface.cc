...
int AndroidInterface::getBattery()
{
    jint result = QAndroidJniObject::callStaticMethod<jint>("org/mavlink/qgroundcontrol/QGCActivity","getBatteryLevel","()I");
  return result;
}

QString AndroidInterface::getTime(){

    QAndroidJniObject value = QAndroidJniObject::callStaticObjectMethod("org/mavlink/qgroundcontrol/QGCActivity","getTime","()Ljava/lang/String;");
