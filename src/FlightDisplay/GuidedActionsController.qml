...
Item {
    ...
    readonly property string takeoffMessage:                    qsTr("Yerden kalkış yap ve konumunu koru."/*"Takeoff from ground and hold position."*/)
    readonly property string gripperMessage:                       qsTr("Grab or Release the cargo")
    readonly property string startMissionMessage:               qsTr("Yerden kalkış yap ve mevcut görevi başlat."/*"Takeoff from ground and start the current mission."*/)
    readonly property string continueMissionMessage:            qsTr("Mevcut waypoint'den göreve devam et."/*"Continue the mission from the current waypoint."*/)
    readonly property string resumeMissionUploadFailMessage:    qsTr("Upload of resume mission failed. Confirm to retry upload")
    readonly property string landMessage:                       qsTr("Aracı mevcut konumunda indir."/*"Land the vehicle at the current position."*/)
    readonly property string rtlMessage:                        qsTr("Aracı kalkış konumuna geri döndür."/*"Return to the launch position of the vehicle."*/)
    ...
    readonly property string pauseMessage:                      qsTr("Aracın mevcut konumunda durmasını sağlayın, gerekli oldukça irtifasını yukarı veya aşağı ayarlayın."/*"Pause the vehicle at it's current position, adjusting altitude up or down as needed."*/)
