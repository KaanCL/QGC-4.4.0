...
Item {
   ...
   // property int toolBarTextSize : Screen.width > 1020 ?  Screen.width/ 200 : Screen.width/ 90
    ...
    GridLayout {
        ...
        GridLayout {
            ...
            QGCLabel {
                text:               qsTr("Toplam Görev"/*"Total Mission"*/)
                Layout.columnSpan:  5
                font.pointSize:     toolBarTextSize
            }

            QGCLabel { text: qsTr("Mesafe:"/*"Distance:"*/); font.pointSize: toolBarTextSize; }
            QGCLabel {
            ...
            QGCLabel { text: qsTr("Max telem dist:"); font.pointSize: toolBarTextSize; }
            QGCLabel {
            ...
            QGCLabel { text: qsTr("Zaman:"/*"Time:"*/); font.pointSize: toolBarTextSize; }
            QGCLabel {
                text:                   getMissionTime()
                font.pointSize:        toolBarTextSize
                Layout.minimumWidth:    _largeValueWidth
